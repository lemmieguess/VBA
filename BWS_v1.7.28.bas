...
' ============================================================================
' Bridgewater Studio - BWS v1.7.28 - UserForm Settings & Improved Toolbar
' Based on: v1.7.27 with line continuation fix
'
...
Public Sub BWS_Settings()
    ' NEW v1.7.28: Try UserForm first, fall back to InputBox
    ...
    ' Check if BWS_SettingsForm exists
    Dim frm As Object
    ...
    ' Try to use UserForm if it exists
    If formExists Then
        On Error Resume Next
        BWS_SettingsForm.Show
        On Error GoTo 0
    Else
