...
' ============================================================================
' Bridgewater Studio - BWS v1.7.26 - Improved Settings & Toolbar Tooltips
' Based on: v1.7.25 with obsolete signature formatting removed
'
...
Public  Const BWS_VERSION   As String = "v1.7.26"
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.26 Installer!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_Settings()
    ...
    Do While continueLoop
        ...
        msg = "╔══════════════════════════════════════════════════════╗" & vbCrLf & _
              "║              BWS SETTINGS MANAGER                    ║" & vbCrLf & _
              "╚══════════════════════════════════════════════════════╝" & vbCrLf & vbCrLf & _
              "Current Configuration:" & vbCrLf & _
              "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" & vbCrLf & vbCrLf & _
              "1. Base Folder" & vbCrLf & _
              "   " & TruncatePath(GetSettingStr("BasePath", "(not set)"), 48) & vbCrLf & vbCrLf & _
              "2. Drafts Folder" & vbCrLf & _
              "   " & TruncatePath(GetSettingStr("DraftsPath", "(not set)"), 48) & vbCrLf & vbCrLf & _
              "3. Template File" & vbCrLf & _
              "   " & TruncatePath(GetSettingStr("TemplatePath", "(not set)"), 48) & vbCrLf & vbCrLf & _
              "4. Auto-Open Folder:  " & GetSettingStr("AutoOpenFolder", "False") & vbCrLf & vbCrLf & _
              "5. Bullet Conversion: " & GetSettingStr(BWS_REG_BULLET_CONVERT, "Yes") & vbCrLf & vbCrLf & _
              "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" & vbCrLf & _
              "Enter 1-5 to change a setting, or 0 to exit:"
        ...
        Select Case userInput
            Case "1"  ' Base folder
                ...
                If LenB(newValue) > 0 Then
                    ...
                    MsgBox "✓ Base folder updated successfully!" & vbCrLf & vbCrLf & _
                           newValue, vbInformation, "BWS Settings"
                End If
            ...
            Case "2"  ' Drafts folder
                ...
                If LenB(newValue) > 0 Then
                    ...
                    MsgBox "✓ Drafts folder updated successfully!" & vbCrLf & vbCrLf & _
                           newValue, vbInformation, "BWS Settings"
                End If
            ...
            Case "3"  ' Template file
                ...
                If LenB(newValue) > 0 Then
                    ...
                    MsgBox "✓ Template file updated successfully!" & vbCrLf & vbCrLf & _
                           newValue, vbInformation, "BWS Settings"
                End If

            Case "4"  ' Auto-open folder
                choice = MsgBox("Auto-open folder when saving documents?" & vbCrLf & vbCrLf & _
                               "Current setting: " & GetSettingStr("AutoOpenFolder", "False") & vbCrLf & vbCrLf & _
                               "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" & vbCrLf & _
                               "Yes = Enable auto-open" & vbCrLf & _
                               "No  = Disable auto-open" & vbCrLf & _
                               "Cancel = Keep current setting", _
                               vbYesNoCancel + vbQuestion, "Auto-Open Folder")
            ...
            Case "5"  ' Bullet conversion
                choice = MsgBox("Enable automatic bullet conversion during import?" & vbCrLf & vbCrLf & _
                               "Current setting: " & GetSettingStr(BWS_REG_BULLET_CONVERT, "Yes") & vbCrLf & vbCrLf & _
                               "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" & vbCrLf & _
                               "Yes = Enable auto-conversion" & vbCrLf & _
                               "No  = Disable auto-conversion" & vbCrLf & _
                               "Cancel = Keep current setting", _
                               vbYesNoCancel + vbQuestion, "Bullet Conversion")
                If choice = vbYes Then
                    SaveSettingStr BWS_REG_BULLET_CONVERT, "Yes"
            ...
            Case Else
                MsgBox "Invalid choice: " & userInput & vbCrLf & vbCrLf & _
                       "Please enter a number from 1-5, or 0 to exit.", _
                       vbExclamation, "BWS Settings"
        End Select
    Loop
End Sub
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.26 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.26, v1.7.25, v1.7.24, v1.7.23)
    msg = "================ BWS v1.7.26 =================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.26:" & vbCrLf _
        & "• Improved settings interface (menu-driven)" & vbCrLf _
        & "• Updated toolbar tooltips (manual vs auto)" & vbCrLf _
        & vbCrLf _
        & "From v1.7.25:" & vbCrLf _
        & "• BUGFIX: Removed signature image conversion" & vbCrLf _
        & vbCrLf _
        & "From v1.7.24:" & vbCrLf _
        & "• BUGFIX: Import Pick creates template doc" & vbCrLf _
        & vbCrLf _
        & "From v1.7.23:" & vbCrLf _
        & "• Col 3 (Budget): 1.375"" (was 1.7"")" & vbCrLf _
        & vbCrLf _
        & "From v1.7.22:" & vbCrLf _
        & "• Table width: 7.75"" (was 7.68"")" & vbCrLf _
        & vbCrLf _
        & "From v1.7.21:" & vbCrLf _
        & "• Col 1 (Tier): 1.45"" fixed" & vbCrLf _
        & "• Col 2 (Experience): 5"" fixed" & vbCrLf _
        & vbCrLf _
        & "From v1.7.19:" & vbCrLf _
        & "• Bullet marker at 0.25""" & vbCrLf
