...
' ============================================================================
' Bridgewater Studio - BWS v1.7.23 - Column 3 Width Adjustment
' Based on: v1.7.22 with table width set to 7.75"
'
...
Public  Const BWS_VERSION   As String = "v1.7.23"
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.23 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.23 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.23, v1.7.22, v1.7.21, v1.7.19)
    msg = "================ BWS v1.7.23 =================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.23:" & vbCrLf _
