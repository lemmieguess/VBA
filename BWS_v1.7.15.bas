...
' ============================================================================
' Bridgewater Studio - BWS v1.7.15 - Bullet Formatting Fix (Hanging Indent)
' Based on: v1.7.14 with bullet formatting enhancements
'
...
Public  Const BWS_VERSION   As String = "v1.7.15"
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.15 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.15 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.15, v1.7.14, v1.7.13)
    msg = "================ BWS v1.7.15 =================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.15:" & vbCrLf _
        & "• Fixed bullet hanging indent" & vbCrLf _
        & "• FirstLineIndent: -0.25"" (not 0)" & vbCrLf _
        & "• Matches perfect document formatting" & vbCrLf _
        & vbCrLf _
        & "From v1.7.14:" & vbCrLf _
        & "• Bullet formatting improvements" & vbCrLf _
        & vbCrLf _
