...
Public  Const BWS_VERSION   As String = "v1.6.6"
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.6.6 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.6.6 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    msg = "================ BWS v1.6.6 ==================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.6.6:" & vbCrLf _
        & "• Signature: Fixed content preservation" & vbCrLf _
        & "• Paragraphs: Clear hanging indent globally" & vbCrLf _
