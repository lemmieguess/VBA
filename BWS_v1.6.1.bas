...
' ============================================================================
' Bridgewater Studio - BWS v1.6.1 - Line Spacing Bugfix
' Based on: v1.6 with critical line spacing fix
'
' v1.6.1 BUGFIX:
...
Public  Const BWS_VERSION   As String = "v1.6.1"
...
Public Sub BWS_Install()
    ...
    MsgBox "Welcome to BWS v1.6.1 Installer!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    Dim msg As String
    msg = "================ BWS v1.6.1 ==================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.6.1:" & vbCrLf _
