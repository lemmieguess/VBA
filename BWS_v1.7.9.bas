...
Public  Const BWS_VERSION   As String = "v1.7.9"
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.9, v1.7.8, v1.7.7)
    msg = "================ BWS v1.7.9 ==================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.9:" & vbCrLf _
        & "• Bullet fix applies to ALL bullets" & vbCrLf _
        & "• Better signature protection" & vbCrLf _
        & vbCrLf _
        & "From v1.7.8:" & vbCrLf _
        & "• Fixed signature image deletion" & vbCrLf _
        & "• Fixed bullet vertical alignment" & vbCrLf
