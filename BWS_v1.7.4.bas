...
Public  Const BWS_VERSION   As String = "v1.7.4"
...
Private Sub ImportDocument(ByVal sourcePath As String)
    ...
    ' 2. Strip whitespace - aggressive approach for whole document
...
Private Sub FormatSignatureBlock(ByVal doc As Document)
    ...
    If Not bodyCC Is Nothing Then
        ...
        For i = 1 To parasToDelete.Count
            On Error Resume Next
            ' Delete the greeting line and next several paragraphs
            Dim startPara As Paragraph
            Set startPara = parasToDelete(i)
            Dim j As Long
            For j = 1 To 6  ' Delete greeting + 5 more lines
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.4, v1.7.3, v1.7.2)
    msg = "================ BWS v1.7.4 ==================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.4:" & vbCrLf _
        & "• Fixed line continuation compiler error" & vbCrLf _
        & vbCrLf _
        & "From v1.7.3:" & vbCrLf _
        & "• DELETE imported signatures" & vbCrLf _
        & "• Simplified whitespace stripping" & vbCrLf _
        & "• Only ONE signature (template)" & vbCrLf _
        & vbCrLf _
        & "From v1.7.2:" & vbCrLf _
        & "• Top margin: 0.5""" & vbCrLf _
        & vbCrLf _
        & "From v1.7.0:" & vbCrLf _
        & "• One-click import workflow!" & vbCrLf _
        & "• Import Newest: Creates doc + imports" & vbCrLf
