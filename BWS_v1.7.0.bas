...
' ============================================================================
' Bridgewater Studio - BWS v1.7.0 - One-Click Import Workflow
' Based on: v1.6.6 with workflow improvement
'
' v1.7.0 NEW FEATURE:
...
Public  Const BWS_VERSION   As String = "v1.7.0"
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.0 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.0 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    msg = "================ BWS v1.7.0 ==================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.0:" & vbCrLf _
        & "• One-click import workflow!" & vbCrLf _
        & "• Import Newest: Creates doc + imports" & vbCrLf _
        & "• Eliminates manual two-step process" & vbCrLf _
        & vbCrLf _
