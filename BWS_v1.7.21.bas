...
' ============================================================================
' Bridgewater Studio - BWS v1.7.21 - Precise Table Column Widths
' Based on: v1.7.20 with exact column width specifications
'
' v1.7.21 USER REQUIREMENTS:
' - "Table width: 7.68"" (not 7")
...
'
' - Total column widths: 586.8 points (8.15") - slightly wider than table
'   * Columns will auto-adjust proportionally within 7.68" table width
'
...
Public  Const BWS_VERSION   As String = "v1.7.21"
...
Private Const TABLE_WIDTH_IN As Double = 7.68  ' inches - preferred table width
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.21 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.21 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.21, v1.7.20, v1.7.19)
    msg = "================ BWS v1.7.21 =================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.21:" & vbCrLf _
        & "• Table width: 7.68"" (was 7"")" & vbCrLf _
        & "• Col 1 (Tier): 1.45"" fixed" & vbCrLf _
        & "• Col 2 (Experience): 5"" fixed" & vbCrLf _
        & "• Col 3 (Budget): 1.7"" fixed" & vbCrLf _
        & vbCrLf _
        & "From v1.7.19:" & vbCrLf _
        & "• Bullet marker at 0.25""" & vbCrLf _
        & vbCrLf _
        & "From v1.7.18:" & vbCrLf _
        & "• Vertical baseline at left edge (0"")" & vbCrLf
