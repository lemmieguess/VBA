...
' ============================================================================
' Bridgewater Studio - BWS v1.7.22 - Table Width Correction
' Based on: v1.7.21 with table width adjustment
'
' v1.7.22 USER REQUIREMENT:
' - "Preferred table width wasn't set, set it at 7.75""
'   * PreferredWidth = 558 points (7.75 * 72)
'   * Column widths remain: Col1=1.45", Col2=5", Col3=1.7"
'
...
'
' - "Column 3: 1.7"" (Budget column)
'   * PreferredWidth = 122.4 points (1.7 * 72)
'
...
Public  Const BWS_VERSION   As String = "v1.7.22"
...
Private Const COL3_WIDTH_IN As Double = 1.7   ' inches - Budget column
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.22 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub FormatTable(ByVal t As Table)
    ...
    ' Column 1: 1.45" (Tier), Column 2: 5" (Experience Focus), Column 3: 1.7" (Budget)
    If t.Columns.Count = 3 Then
        ...
        t.Columns(3).PreferredWidth = Application.InchesToPoints(COL3_WIDTH_IN)  ' 1.7"
        On Error GoTo 0
    End If
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.22 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.22, v1.7.21, v1.7.19)
    msg = "================ BWS v1.7.22 =================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.22:" & vbCrLf _
        & "• Table width: 7.75"" (was 7.68"")" & vbCrLf _
        & vbCrLf _
        & "From v1.7.21:" & vbCrLf _
        & "• Col 1 (Tier): 1.45"" fixed" & vbCrLf _
        & "• Col 2 (Experience): 5"" fixed" & vbCrLf _
        & "• Col 3 (Budget): 1.7"" fixed" & vbCrLf _
        & vbCrLf _
