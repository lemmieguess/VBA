...
Public  Const BWS_VERSION   As String = "v1.7.6"
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.6, v1.7.5, v1.7.4)
    msg = "================ BWS v1.7.6 ==================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.6:" & vbCrLf _
        & "• Fixed Dim statements inside loop" & vbCrLf _
        & vbCrLf _
        & "From v1.7.5:" & vbCrLf _
        ...
        & "• Fixed line continuation compiler error" & vbCrLf
