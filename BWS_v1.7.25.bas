...
' ============================================================================
' Bridgewater Studio - BWS v1.7.25 - Remove Obsolete Signature Formatting
' Based on: v1.7.24 with Import Pick bug fixed
'
' v1.7.25 BUGFIX:
...
Public  Const BWS_VERSION   As String = "v1.7.25"
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.25 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.25 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.25, v1.7.24, v1.7.23, v1.7.22)
    msg = "================ BWS v1.7.25 =================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.25:" & vbCrLf _
        & "• BUGFIX: Removed signature image conversion" & vbCrLf _
        & "• Signature protected in template (no errors!)" & vbCrLf _
        & vbCrLf _
        & "From v1.7.24:" & vbCrLf _
        & "• BUGFIX: Import Pick creates template doc first" & vbCrLf _
        & "• File picker opens in Drafts folder" & vbCrLf _
        & vbCrLf _
