...
' ============================================================================
' Bridgewater Studio - BWS v1.7.17 - Complete Formatting Overhaul
' Based on: v1.7.13 with comprehensive formatting fixes
'
...
'
' - Regular paragraphs: 0.5" left indent, NO hanging indent
'   * User requirement: "half inch indent, but not hanging indent"
'   * LeftIndent = 0.5", FirstLineIndent = 0"
'
' - Bullets: Proper hanging indent (from v1.7.15)
...
Public  Const BWS_VERSION   As String = "v1.7.17"
...
' -------- Formatting prefs --------
Private Const PARA_LEFT_IN As Double = 0.5  ' NEW v1.7.17: Regular paragraph indent
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.17 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.17 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.17, v1.7.15, v1.7.13)
    msg = "================ BWS v1.7.17 =================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.17:" & vbCrLf _
        ...
        & "• Bullets: Hanging indent (-0.25"")" & vbCrLf _
        & vbCrLf _
