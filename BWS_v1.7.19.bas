...
' ============================================================================
' Bridgewater Studio - BWS v1.7.19 - Bullet Marker Indent Adjustment
' Based on: v1.7.18 with bullet marker position fix
'
...
Public  Const BWS_VERSION   As String = "v1.7.19"
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.19 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub FormatTable(ByVal t As Table)
    ...
    ' NEW v1.7.18: Make description/experience columns 30% wider
    ...
    If descColIndex > 0 And t.Columns.Count > 1 Then
        On Error Resume Next
        ' Give the description column 30% more width
        ' We'll use AutoFit first, then expand the description column
        t.AutoFitBehavior wdAutoFitContent

        ' Get current width and make it 30% bigger
        Dim currentWidth As Single
        currentWidth = t.Columns(descColIndex).Width
        t.Columns(descColIndex).Width = currentWidth * 1.3
        On Error GoTo 0
    End If
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.19 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.19, v1.7.18, v1.7.17)
    msg = "================ BWS v1.7.19 =================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.19:" & vbCrLf _
        & "• Bullet marker at 0.25"" (was 0"")" & vbCrLf _
        & "• Text wrapping at 0.5"" (unchanged)" & vbCrLf _
        & vbCrLf _
        & "From v1.7.18:" & vbCrLf _
        & "• Vertical baseline at left edge (0"" indent)" & vbCrLf _
        & "• Tables: Description column 30% wider" & vbCrLf _
        & vbCrLf _
        & "From v1.7.17:" & vbCrLf _
        & "• Format ONLY body content, not whole doc" & vbCrLf
