...
' ============================================================================
' Bridgewater Studio - BWS v1.7.24 - Import Pick Bug Fix
' Based on: v1.7.23 with column 3 width at 1.375"
'
' v1.7.24 BUGFIX:
...
Public  Const BWS_VERSION   As String = "v1.7.24"
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.24 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.24 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.24, v1.7.23, v1.7.22, v1.7.21)
    msg = "================ BWS v1.7.24 =================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.24:" & vbCrLf _
        & "• BUGFIX: Import Pick now creates template doc first" & vbCrLf _
