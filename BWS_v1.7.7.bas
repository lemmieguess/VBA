...
Public  Const BWS_VERSION   As String = "v1.7.7"
...
Private Sub FormatSignatureBlock(ByVal doc As Document)
    ...
    If Not bodyCC Is Nothing Then
        ...
        For i = parasToDelete.Count To 1 Step -1
            ...
            ' MoveEnd extends the END of the range by N units
            deleteRange.MoveEnd Unit:=wdParagraph, Count:=5

            ' Delete the entire range (6 paragraphs) at once
            deleteRange.Delete
            On Error GoTo 0
        Next i
    End If
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.7, v1.7.6, v1.7.5)
    msg = "================ BWS v1.7.7 ==================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.7:" & vbCrLf _
        & "• Fixed Paragraph.Index error" & vbCrLf _
        & "• Using Range.MoveEnd for deletion" & vbCrLf _
        & vbCrLf _
        ...
        & "• Whitespace stripping runs LAST" & vbCrLf
