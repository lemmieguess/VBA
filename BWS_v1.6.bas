...
' ============================================================================
' Bridgewater Studio - BWS v1.6 - Perfect Formatting Match
' Based on: v8.0.2 FIXED + 6 formatting improvements from Epic BWS-1.6
'
' v1.6 NEW FEATURES:
...
Public  Const BWS_VERSION   As String = "v1.6"
...
Public Sub BWS_Install()
    ...
    MsgBox "Welcome to BWS v1.6 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub ApplyGlobalFormatting(ByVal doc As Document)
    ...
    With doc.Range
        ...
        .ParagraphFormat.LineSpacing = 1.15  ' NEW v1.6: Explicit 1.15 line spacing
    End With
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.6 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    Dim msg As String
    msg = "================ BWS v1.6 ====================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.6:" & vbCrLf _
