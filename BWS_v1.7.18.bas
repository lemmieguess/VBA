...
' ============================================================================
' Bridgewater Studio - BWS v1.7.18 - Baseline Alignment & Table Width Fix
' Based on: v1.7.17 with alignment and table column adjustments
'
...
'   * Result: Bullet at 0", text at 0.5" and aligns vertically
'
...
Public  Const BWS_VERSION   As String = "v1.7.18"
...
Private Const BULLET_HANG_IN As Double = 0.5  ' NEW v1.7.18: Half-inch hanging indent
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.18 Installer!" & vbCrLf & vbCrLf & _
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.18 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.18, v1.7.17, v1.7.13)
    msg = "================ BWS v1.7.18 =================" & vbCrLf _
        & "Version: " & BWS_VERSION & vbCrLf _
        & "Host:    " & Application.Name & " " & Application.Version & vbCrLf _
        & vbCrLf _
        & "NEW in v1.7.18:" & vbCrLf _
        & "• Vertical baseline at left edge (0"" indent)" & vbCrLf _
        & "• Bullets: Standard 0.5"" indent with hanging" & vbCrLf _
        & "• Tables: Description column 30% wider" & vbCrLf _
        & vbCrLf _
        & "From v1.7.17:" & vbCrLf _
        & "• Format ONLY body content, not whole doc" & vbCrLf _
        & vbCrLf _
        & "From v1.7.13:" & vbCrLf _
        & "• Fixed table indent: RightIndent = 0" & vbCrLf _
        & "• Fixed signature image preservation" & vbCrLf
