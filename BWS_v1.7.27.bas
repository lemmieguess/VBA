...
' ============================================================================
' Bridgewater Studio - BWS v1.7.27 - Fix Line Continuation Limit
' Based on: v1.7.26 with improved settings interface
'
' v1.7.27 BUGFIX:
...
Public  Const BWS_VERSION   As String = "v1.7.27"
...
Public Sub BWS_Install()
    ...
    If Not useExisting Then
        MsgBox "Welcome to BWS v1.7.27 Installer!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_Settings()
    ' NEW v1.7.26: Improved settings interface
    ' - Loop to allow multiple changes
    ' - Better formatting and UX
    ' - "0" to exit instead of Cancel
...
Private Sub BuildOrRefreshBWSToolbar(ByVal showMessage As Boolean)
    ...
    If showMessage Then
        MsgBox "BWS v1.7.27 toolbar installed!" & vbCrLf & vbCrLf & _
...
Public Sub BWS_About()
    ...
    ' Part 1: Header and recent versions (v1.7.27, v1.7.26, v1.7.25, v1.7.24)
    msg = "================ BWS v1.7.27 =================" & vbCrLf
    msg = msg & "Version: " & BWS_VERSION & vbCrLf
    msg = msg & "Host:    " & Application.Name & " " & Application.Version & vbCrLf & vbCrLf
    msg = msg & "NEW in v1.7.27:" & vbCrLf
    msg = msg & "• BUGFIX: Fixed line continuation limit" & vbCrLf & vbCrLf
    msg = msg & "From v1.7.26:" & vbCrLf
    msg = msg & "• Improved settings interface" & vbCrLf & vbCrLf
